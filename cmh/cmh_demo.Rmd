...
Within the original CDISC Pilot Project, the example CSR included the use of the CMH test. For portions of the analysis, the statistical analysis plan specifically calls out the following:
...
The data here are taken from the the [PHUSE Test Data Factory](https://advance.phuse.global/display/WEL/Test+Dataset+Factory) replication of the CDISC Pilot Project (original data aren't easily accessible at this point). 
