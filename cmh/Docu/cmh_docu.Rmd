...
|   3| 2x2x3  | X = TRTP, Y = SEX, K = RACE  |  General Association |   Imbalanced?|
|   6| 2x5x2  | X = TRTP, Y = AVAL, K = SEX  |  Row Means |   Filtered|
...
A solution for this error is offered by the forked version of the vcdPackage (**NOT PART OF THE CRAN PACKAGE**). _Link Github Issue_.
