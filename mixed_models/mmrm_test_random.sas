...
proc export data=diffs
   outfile="/lillyce/qa/vct/common/tfl/test_andy/phuse/output/LSMeansDifferences_ANCOVA_random_&ddfmvalue._ADLBH_GithubData.csv" 
   dbms=csv replace;
run;

proc export data=lsmeans
   outfile="/lillyce/qa/vct/common/tfl/test_andy/phuse/output/LSMeans_ANCOVA_random_&ddfmvalue._ADLBH_GithubData.csv" 
   dbms=csv replace;
run;
