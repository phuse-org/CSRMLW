...
proc export data=diffs
   outfile="/lillyce/qa/vct/common/tfl/test_andy/phuse/output/LSMeansDifferences_ANCOVAwithRepeatedMeasures_&ddfmvalue._ADLBH_GithubData.csv" 
   dbms=csv replace;
run;

proc export data=lsmeans
   outfile="/lillyce/qa/vct/common/tfl/test_andy/phuse/output/LSMeans_ANCOVAwithRepeatedMeasures_&ddfmvalue._ADLBH_GithubData.csv" 
   dbms=csv replace;
run;
